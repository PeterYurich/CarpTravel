        ...
        '>
            ...
            '>
                <h2 className='uppercase text-right flex flex-col mb-6
                 md:absolute right-0 '>
                    <p className='text-37 track -mb-4  tracking-[1.7px] 
                    md:text-67 md:-mb-6 md:tracking-[8.7px] 
                    lg:text-98 lg:tracking-tight lg:-mb-9 
                    '>
                        <span className='font-medium mr-1 '>{titlePart1}</span>
                        <span className='font-thin'>{titlePart2}</span>
                    </p>
                    <p className='font-light tracking-[10px] leading-loose text-12 translate-x-1
                    md:text-14 md:tracking-[27px] md:translate-x-2
                    lg:text-16 lg:tracking-[33px] lg:translate-x-6
                    '>
                        {titlePart3}
                    </p>
                </h2>
                ...
                lg:text-98 lg:tracking-[-3.9px] lg:mb-[148px]
                '>
                ...
                {pageWidth < 1280 ?
                    <p className='mb-6 text-10 font-extralight tracking-[1.7px]
                    md:text-14  md:tracking-[1.3px] md:mb-0
                    '>
                        <div>{subtitle1}</div>
                        <div>{subtitle2}</div>
                    </p>
                    :
                    <p className='font-extralight text-16 tracking-[1.5px]'>
                        {subtitleJoined}
                    </p>
                }
                <p className='text-14 font-extralight mb-6 text-justify
                md:absolute md:top-36 md:right-0 md:w-[230px] md:text-16  
                lg:top-[380px] lg:w-[294px] lg:text-18
                '>
                    {description}
                </p>
